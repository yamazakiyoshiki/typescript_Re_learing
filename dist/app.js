...
class ProjectState extends State {
    ...
    addProject(title, description, monday) {
        const newProject = new Project(Math.random.toString(), title, description, monday, ProjectStatus.Active);
...
function validate1(validatableInput) {
    let isValid = true;
